        ...
        <div className="min-h-screen bg-[#F7F7F7] font-sans text-[#1A1A1A] antialiased">
            <main className="max-w-2xl mx-auto px-8 py-32 md:py-48">
                <header className="mb-32">
                    <h1 className="text-4xl font-light  mb-6 uppercase tracking-widest">Terms of Service</h1>
                    <div className="h-px w-20 bg-[#1A1A1A] mb-12"></div>
                    <p className="text-xl text-[#555555] font-light leading-relaxed italic">
                ...
                <article className="space-y-20">
                    <div className="space-y-4">
                        <h2 className="text-xs font-semibold tracking-[0.3em] uppercase">The Foundation</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xs font-semibold tracking-[0.3em] uppercase">Original Design</h2>
                        <p className="text-[#555555] font-light leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xs font-semibold tracking-[0.3em] uppercase">Limitation</h2>
                        <p className="text-[#555555] font-light leading-relaxed">
                    ...
                    <div className="space-y-4 pt-12">
                        <p className="text-[10px] text-[#E0E0E0] tracking-widest uppercase italic">
